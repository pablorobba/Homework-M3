...
UPDATE `producto` SET Precio = Precio2;
...
-- SELECT * FROM cliente;
-- SELECT TRIM('     Hola Mundo    ') as palabra;
...
INSERT INTO aux_venta (IdVenta, Fecha, Fecha_Entrega, IdCliente, IdSucursal, IdEmpleado, IdProducto,
